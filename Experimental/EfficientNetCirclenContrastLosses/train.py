...
class CarsReidentificationTrainEffnet(pl.LightningModule):
    ...
    def __init__(self, num_classes=5540, pretain_path=None, model_name="s"):
        super().__init__()
...
if __name__ == "__main__":
    ...
    DATASET_ROOT_DIR = "C:/Users/user/Desktop/hacksignal/CASIA-WebFace_cropped"
    LOGS_DIR = "./logs"
    ...
    trainer_cfg = {
        ...
        "max_epochs": 2,
        "callbacks": [
            pl.callbacks.ModelCheckpoint(dirpath=LOGS_DIR, every_n_train_steps=1000, save_top_k=-1),
